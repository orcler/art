...
<form id="inconf_form" method="post">
	<table class="easyui-datagrid" title="入库待确认列表" id="inconf_dg" data-options="rownumbers:true,url:'./dataquery.form?qtype=inconf',method:'get',singleSelect:true,toolbar:'#inconf_ft'">
	<thead>
		<tr>
